...
| -------------- | ------- | ------- | ------- | --------- |
| BHT 预测器     | 92.1478 | 92.1466 | 92.1443 | 92.2152   |
| 全局历史预测器 | 89.0004 | 88.9598 | 88.7958 | 89.0693   |
| 锦标赛预测器   | 91.8288 | 91.9465 | 91.9755 | 92.0148   |
| TAGE 预测器    | 95.4822 | 95.5305 | 95.5412 | 95.5723   |
...
| GH: `gw=8`, `e=11`, `sw=2`, `hash`                    | `hash_xor` | `hash_xor` | `hash_xor` | `hash_xor` |
| Tournament: `GH.hash`                                 | `hash_xor` | `hash_xor` | `hash_xor` | `hash_xor` |
