...
| -------------- | ------- | ------- | ------- | --------- |
| BHT 预测器     | 92.9136 | 92.8144 | 92.9755 | 93.0238   |
| 全局历史预测器 | 89.8937 | 89.8428 | 90.1353 | 90.0269   |
| 锦标赛预测器   | 91.0756 | 90.9495 | 91.2041 | 91.189    |
| TAGE 预测器    | 95.919  | 95.862  | 95.9615 | 95.94     |
...
| TAGE:`tn=2`, `T0_e=13`, `T1_gw=3`, `a=1`, `Tn_e=10` |            |            |            |            |
...
| 预测器     | `bzip`  | `sjeng` | `wrf`   | `sphinx3` |
| ---------- | ------- | ------- | ------- | --------- |
| BHT        | 97.6244 | 97.5572 | 97.6342 | 97.4035   |
| GH         | 90.7617 | 90.0554 | 90.8733 | 90.2393   |
| Tournament | 93.2199 | 93.0578 | 93.3601 | 92.8469   |
...
限制于预测器的大小， TAGE 预测器并没有出现预期中的表现，预测正确率仅有 $96\%$ 左右。经过多次参数测试，当子预测器只有两个的时候预测效果最好。
